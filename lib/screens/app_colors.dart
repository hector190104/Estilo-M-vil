...
class AppColors {
  ...
  static const Color primary500 = Color(
    0xFFEF4444,
  ); // Usado como --primary-color en algunos HTML
  ...
  static const Color progressActive = Color(
    0xFFE63946,
  ); // Usado como --primary-color en HTML y botones

  // Paleta Neutrales (Grises)
  static const Color gray50 = Color(
    0xFFF9FAFB,
  ); // Añadido desde HTML pago (bg-gray-50)
  ...
  static const Color green400 = Color(
    0xFF34D399,
  ); // bg-green-400 (disponible leyenda)
  static const Color green500 = Color(0xFF22C55E);
  static const Color green700 = Color(0xFF059669);
  static const Color yellowStar = Color(
    0xFFFBBF24,
  ); // text-yellow-400 (estrella), bg-amber-400 (limitado leyenda)
  static const Color yellow500 = Color(0xFFEAB308);
  static const Color yellow700 = Color(0xFFB45309);
  static const Color red400 = Color(
    0xFFF87171,
  ); // bg-red-400 (no disponible leyenda)
  ...
  static const Color mutedForeground = Color(
    0xFF6B7280,
  ); // --muted-foreground (es gray500)
  static const Color foregroundColor = Color(
    0xFF121212,
  ); // --foreground-color (casi negro)

  // --- AÑADIR ESTE NUEVO COLOR ---
  // Color para el fondo del icono del diálogo de confirmación
  static const Color dialogIconBg = Color(0xFFE0F2FE); // bg-[#E0F2FE]
}
